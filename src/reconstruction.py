...
class IncrementalSfM:
    ...
    def add_view(self, img_cv):
        ...
        print(f"    [2] Matching with previous view...")
        ...
        # Step 3: Find 2D-3D correspondences for PnP
        print(f"    [3] Finding 2D-3D correspondences...")
        points_3d_for_pnp = []
        points_2d_for_pnp = []
        match_to_3d_idx = []
        ...
        print(f"    [5] Triangulating new points...")
